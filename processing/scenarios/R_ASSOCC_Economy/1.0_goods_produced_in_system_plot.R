...
plotEcoSystemGoodsProd <- function(df_economy, output_dir, one_plot) {
  ...
  print(plot_ggplot(seg_goods_produced_in_system))
  dmfPdfClose()
  
  dmfPdfOpen(output_dir, "eco_goods_produced_in_system_smooth_uncertainty")
  print(plot_ggplot_smooth_uncertainty(df_goods_produced_in_system_mean_std))
  dmfPdfClose()
  
  dmfPdfOpen(output_dir, "eco_goods_produced_in_system_smooth")
  print(plot_ggplot_smooth(df_goods_produced_in_system_mean_std))
  dmfPdfClose()
