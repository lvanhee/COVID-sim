...
setup-measures-for-phasing-out</setup>
    ...
    <metric>#workers-at-start</metric>
    <metric>#retireds-at-start</metric>
    <metric>ratio-omniscious-infected-that-trigger-non-essential-closing-measure</metric>
    <metric>ratio-omniscious-infected-that-trigger-private-leisure-closing-measure</metric>
    <metric>ratio-omniscious-infected-that-trigger-recommendation-working-from-home-measure</metric>
    <metric>ratio-omniscious-infected-that-trigger-school-closing-measure</metric>
    <metric>ratio-omniscious-infected-that-trigger-social-distancing-measure</metric>
    <metric>ratio-omniscious-infected-that-trigger-university-closing-measure</metric>
    <metric>ratio-omniscious-infected-that-trigger-workplace-closing-measure</metric>
    ...
    <enumeratedValueSet variable="condition-for-acknowledging-the-crisis">
      <value value="&quot;ratio infected&gt;acknowledgement-ratio&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="condition-phasing-out">
      <value value="&quot;new infections percentage of average over day gap&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="day-gap-for-phasing-out-condition">
      <value value="21"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="minimum-days-between-phases">
      <value value="31"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="next-phase-condition-percentage">
      <value value="0.5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ratio-capacity-partial-opening-private-leisure">
      <value value="0.5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="force-full-bus-capacity-after-phase">
      <value value="&quot;phase-2&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="force-full-reopening-of-private-leisure-after-phase">
      <value value="&quot;phase-2&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="force-partial-reopening-of-private-leisure-after-phase">
      <value value="&quot;never&quot;"/>
      <value value="&quot;phase-1&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="force-release-recommendation-working-from-home-after-phase">
      <value value="&quot;never&quot;"/>
      <value value="&quot;phase-2&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="force-releasing-of-social-distancing-measure-after-phase">
      <value value="&quot;phase-2&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="force-releasing-retirees-from-isolation-after-phase">
      <value value="&quot;phase-2&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="force-reopening-of-non-essential-after-phase">
      <value value="&quot;phase-1&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="force-reopening-of-schools-after-phase">
      <value value="&quot;phase-1&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="force-reopening-of-universities-after-phase">
      <value value="&quot;phase-2&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="force-reopening-of-workplaces-after-phase">
      <value value="&quot;phase-1&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="preset-scenario">
      <value value="&quot;scenario-12-exit-strategies&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="household-profiles">
      <value value="&quot;Sweden&quot;"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="close-universities?">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="close-workplaces?">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="contagion-model">
      <value value="&quot;oxford&quot;"/>
    ...
    <enumeratedValueSet variable="recommend-working-from-home?">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="services-luxury-ratio-of-expenditures-when-closed">
      <value value="0.2"/>
...
setup-measures-for-phasing-out</setup>
    ...
    <enumeratedValueSet variable="condition-phasing-out">
      <value value="&quot;hospital not overrun &amp; #hospitalizations has decreased in day gap&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="day-gap-for-phasing-out-condition">
      <value value="21"/>
    </enumeratedValueSet>
...
setup-measures-for-phasing-out</setup>
  ...
  <experiment name="S12-PublicServices_Static" repetitions="1" runMetricsEveryStep="true">
    <setup>setup
set ratio-omniscious-infected-that-trigger-recommendation-working-from-home-measure acknowledgement-ratio
set ratio-omniscious-infected-that-trigger-social-distancing-measure acknowledgement-ratio
set ratio-omniscious-infected-that-trigger-university-closing-measure acknowledgement-ratio
...
setup-measures-for-phasing-out</setup>
  ...
  <experiment name="S12-Leisure_Static" repetitions="1" runMetricsEveryStep="true">
    <setup>setup
set ratio-omniscious-infected-that-trigger-recommendation-working-from-home-measure acknowledgement-ratio
set ratio-omniscious-infected-that-trigger-social-distancing-measure acknowledgement-ratio
set ratio-omniscious-infected-that-trigger-university-closing-measure acknowledgement-ratio
...
setup-measures-for-phasing-out</setup>
  ...
  <experiment name="S12-Business_Static" repetitions="1" runMetricsEveryStep="true">
    <setup>setup
set ratio-omniscious-infected-that-trigger-social-distancing-measure acknowledgement-ratio
set ratio-omniscious-infected-that-trigger-university-closing-measure acknowledgement-ratio
set ratio-omniscious-infected-that-trigger-private-leisure-closing-measure acknowledgement-ratio
...
setup-measures-for-phasing-out</setup>
  ...
  <experiment name="S12_newly_infected_testing_comparison" repetitions="8" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1500"/>
    <metric>#infected</metric>
    ...
    <metric>count should-be-isolators</metric>
    <metric>count should-be-isolators with [current-activity != my-home and current-activity != my-hospital and current-activity != away-gathering-point]</metric>
    <metric>count people with [[gathering-type] of current-activity = "home"]</metric>
    <metric>count people with [[gathering-type] of current-activity = "school"]</metric>
    ...
    <enumeratedValueSet variable="phase-snap-back?">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="next-phase-condition-percentage">
      <value value="0.5"/>
    ...
    <enumeratedValueSet variable="force-reopening-of-migration-after-phase">
      <value value="&quot;phase-1&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="force-reopening-of-non-essential-after-phase">
      <value value="&quot;phase-1&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="force-reopening-of-public-leisure-after-phase">
      <value value="&quot;phase-3&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="force-reopening-of-schools-after-phase">
      <value value="&quot;phase-2&quot;"/>
    ...
    <enumeratedValueSet variable="ratio-omniscious-infected-that-trigger-migration-closing-measure">
      <value value="0.02"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ratio-omniscious-infected-that-trigger-non-essential-closing-measure">
      <value value="0.02"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ratio-omniscious-infected-that-trigger-private-leisure-closing-measure">
      <value value="0.02"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ratio-omniscious-infected-that-trigger-public-leisure-closing-measure">
      <value value="0.02"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ratio-omniscious-infected-that-trigger-recommendation-working-from-home-measure">
      <value value="0.02"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ratio-omniscious-infected-that-trigger-school-closing-measure">
      <value value="0.02"/>
    ...
    <enumeratedValueSet variable="ratio-omniscious-infected-that-trigger-university-closing-measure">
      <value value="0.02"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ratio-omniscious-infected-that-trigger-workplace-closing-measure">
      <value value="0.02"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ratio-omniscious-infected-that-triggers-half-capacity-busses-measure">
      <value value="0.02"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ratio-omniscious-infected-that-triggers-retirees-in-isolation">
      <value value="0.02"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="probability-getting-back-when-abroad">
      <value value="0.12"/>
    ...
    <enumeratedValueSet variable="activate-intra-cultural-variation?">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="all-self-isolate-for-35-days-when-first-hitting-2%-infected?">
      <value value="false"/>
    ...
    <enumeratedValueSet variable="cultural_tightness">
      <value value="50"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="daily-risk-believe-experiencing-fake-symptoms">
      <value value="0"/>
    ...
    <enumeratedValueSet variable="preset-scenario">
      <value value="&quot;scenario-12-business&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="price-of-rations-in-essential-shops">
      <value value="2.8"/>
    </enumeratedValueSet>
